...
@section('content')
    <div class="row mt-4">
        <h4 class="mb-4"><i class="bi bi-pin-map me-2"></i>ຈັດການຂໍ້ມູນກອງປະຈຳ</h4>
        <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge rounded-pill d-inline-flex align-items-center gap-1"
                                            style="background-color: {{ $unit->is_active ? '#EAF3DE' : '#FCEBEB' }};
                                                   color: {{ $unit->is_active ? '#27500A' : '#501313' }};
                                                   font-weight:500; font-size:12px;">
                                            <span class="rounded-circle"
                                                style="width:6px; height:6px; display:inline-block;
                                                       background: {{ $unit->is_active ? '#3B6D11' : '#A32D2D' }};"></span>
                                            {{ $unit->is_active ? 'ໃຊ້ງານ' : 'ບໍ່ໃຊ້ງານ' }}
                                        </span>
                                    </td>
    ...
    <script>
        ...
        waitForBootstrap(function () {
            ...
            document.getElementById('btnCreate').addEventListener('click', function () {
                ...
                unitForm.action      = "{{ route('units.store') }}";
