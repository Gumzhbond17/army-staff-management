...
@section('content')
    <div class="row mt-4">
        <h4 class="mb-4"><i class="bi bi-person-exclamation me-2"></i>ຈັດການຂໍ້ມູນສະຖານະເຮັດວຽກ</h4>
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap py-2 px-3">

                    {{-- Search --}}
                    <form action="{{ route('working-statuses.index') }}" method="GET"
                        ...
                        <a href="{{ route('working-statuses.index') }}"
            ...
            <div class="card-body">
                <div class="table-responsive rounded-3 border">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge rounded-pill d-inline-flex align-items-center gap-1"
                                            style="background-color: {{ $status->is_active ? '#EAF3DE' : '#FCEBEB' }};
                                                   color: {{ $status->is_active ? '#27500A' : '#501313' }};
                                                   font-weight:500; font-size:12px;">
                                            <span class="rounded-circle"
                                                style="width:6px; height:6px; display:inline-block;
                                                       background: {{ $status->is_active ? '#3B6D11' : '#A32D2D' }};"></span>
                                            {{ $status->is_active ? 'ໃຊ້ງານ' : 'ບໍ່ໃຊ້ງານ' }}
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <button type="button"
                                                ...
                                                data-active="{{ $status->is_active ? '1' : '0' }}"
                                                data-url="{{ route('working-statuses.update', $status->id) }}">
                                            ...
                                            <button type="button"
                                                ...
                                                data-name="{{ $status->name }}"
                                                data-url="{{ route('working-statuses.destroy', $status->id) }}">
                    ...
                    <div class="mt-3 mx-3">
                        {{ $statuses->appends(request()->query())->links('pagination::bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
