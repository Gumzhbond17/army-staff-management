                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('nationality') is-invalid @enderror" name="nationality"
                                   value="{{ old('nationality', $employee->nationality) }}" placeholder="ສັນຊາດ" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('ethnicity_group') is-invalid @enderror" name="ethnicity_group"
                                   value="{{ old('ethnicity_group', $employee->ethnicity_group) }}" placeholder="ເຊື້ອຊາດ" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('tribe') is-invalid @enderror" name="tribe"
                                   value="{{ old('tribe', $employee->tribe) }}" placeholder="ຊົນເຜົ່າ" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('religion') is-invalid @enderror" name="religion"
                                   value="{{ old('religion', $employee->religion) }}" placeholder="ສາດສະໜາ" required>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('parents_name') is-invalid @enderror" name="parents_name"
                                   value="{{ old('parents_name', $employee->parents_name) }}" placeholder="ຊື່ພໍ່ ແລະ ແມ່" required>
...
<script>
    ...
    function renderChildren(count) {
        ...
        container.querySelectorAll('.child-dob').forEach(el => {
            ...
            if (el.dataset.date) fp.setDate(el.dataset.date, true);
        });
    }
